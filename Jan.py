...
class __crack__:
	...
	def plerr(self):
		...
		if _jokowi_kontol_ in ('M', 'm'):
				...
				if pwek == '':
					...
					def _sempak_(bse=None):
						...
						if boy == '':
							...
							exit()
					HADI('\n01.) Metode b-api ')
					HADI('02.) Metode mbasic ')
					HADI('03.) Metode Mobile ')
					_sempak_(pwek.split(','))
					break
			...
			HADI('\n\t------[ Method Crack ]-----')
			print (' [*]=============================================')
			HADI(' [1] HADI Method 1 ')
			HADI(' [2] HADI Method 2  [ Pro ]')
			HADI(' [3] HADI Method 3   ')
			print (' [*]=============================================')
			self.__pler__()
		else:
			exit()
	...
	def __api__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;97m [NAZIR] %s/%s  \033[1;92mOK-:%s / \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
...
8888b   888                   Y8P         
88888b  888                               
888Y88b 888  8888b.  88888888 888 888d888 
888 Y88b888     "88b    d88P  888 888P"   
888  Y88888 .d888888   d88P   888 888     
888   Y8888 888  888  d88P    888 888     
888    Y888 "Y888888 88888888 888 888    
 [*]=============================================
    Author   : HADI
 [*]=============================================
